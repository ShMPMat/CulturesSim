...
import io.tashtabash.simulation.space.territory.MutableTerritory
import io.tashtabash.simulation.space.tile.Tile
import io.tashtabash.simulation.space.tile.getClosest
import java.util.*
    ...
    init {
        ...
        for (i in 0 until numberOfSubGroups) {
            ...
            addGroup(Group(
                    ...
                    CultureAspectCenter(
                            ReasonField(cultureConversions(memoryCenter, aspectCenter, populationCenter.stratumCenter))
                    ),
                    TraitCenter(),
                    root,
                    aspectCenter,
