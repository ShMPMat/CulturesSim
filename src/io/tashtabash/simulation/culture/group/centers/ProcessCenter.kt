...
import io.tashtabash.simulation.culture.group.cultureaspect.DepictObject
import io.tashtabash.simulation.culture.group.process.*
import io.tashtabash.simulation.culture.group.process.behaviour.*
...
class ProcessCenter(type: AdministrationType) {
    ...
    private var _behaviours: MutableList<GroupBehaviour> = mutableListOf(
            ...
            CreateCultureAspectsB.withProbability(session.cultureAspectBaseProbability),
